      ...
      <table class="min-w-full border rounded-xl overflow-hidden shadow-sm">
        ...
        <tbody>
          ...
          >
            ...
            <td class="px-3 py-2 text-right">{{ row.day_v }}</td>
           <td class="px-3 py-2 numeric"
...
const columnsData = [
   {"title": "Change From Close" ,"bind" : "gain" , "decimals": 2, "colors":{ "range_min": -2 , "range_max":10 ,  "color_min": "#FFFFFF" , "color_max":"#14A014"   } },
   {"title": "Symbol/News" ,"bind" : "symbol",  "type" :"str" },
   {"title": "Pos" ,"bind" : "rank_delta",  "type" :"rank" },
   {"title": "Price","decimals": 2 ,"bind" : "last"},
   {"title": "Volume","bind" : "day_v" },
   {"title": "Float" ,"bind" : "float"},
   {"title": "Rel Vol 5m","bind" : "rel_vol_5m" },
   {"title": "Rel Vol 5m","bind" : "rel_vol_24" },
   {"title": "Gap","bind" : "gap", "decimals": 1, "colors":{ "range_min": -10 , "range_max":10 ,  "color_min": "#FF0101" , "color_max":"#002FFF"   } }
]
